...
export default function ReportDashboard() {
  ...
  const handleSubmit = async () => {
    if (!senderEmail && !suspiciousLink && !file) {
      setMessage(
        "Debe ingresar al menos un correo, enlace sospechoso o archivo."
      );
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(
          data.message || "Error al enviar reporte"
        );
      }

      setMessage(
        "Reporte enviado correctamente al equipo de seguridad."
      );
    ...
    <div className="flex-1 overflow-y-auto bg-gray-50 p-8">
      <div className="mb-6">
        ...
        <p className="text-gray-600 text-sm leading-relaxed max-w-2xl">
          Reporte enlaces, correos electrónicos o archivos sospechosos
          para su revisión por el equipo de seguridad informática.
        </p>
      </div>
        ...
        <div className="flex-1 bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="border-t border-gray-200 pt-4 flex justify-end">
            <button
              ...
              disabled={loading}
              className="flex items-center gap-2 bg-red-600 hover:bg-red-700 disabled:bg-red-300 text-white font-semibold text-sm py-2.5 px-6 rounded-md transition-colors"
            >
        ...
        <div className="w-64 shrink-0 flex flex-col gap-4">
          <div className="bg-white border border-gray-200 rounded-xl p-5 shadow-sm">
            ...
            <p className="text-xs text-gray-600 leading-relaxed">
              Todos los reportes son enviados automáticamente al
              equipo de seguridad informática para su revisión y
              seguimiento.
            </p>
          </div>
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-5 shadow-sm">
            ...
            <p className="text-xs text-gray-600 leading-relaxed">
              No haga clic en enlaces ni descargue archivos de
              remitentes desconocidos sin verificar primero su
              autenticidad.
            </p>
          </div>
        </div>
      ...
      <div className="mt-10 border-t border-gray-200 pt-4 flex justify-between items-center text-xs text-gray-400">
        <span>
          © 2026 Créditos institucionales UMSS TVU. Todos los derechos
          reservados.
        </span>
