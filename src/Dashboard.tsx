      ...
      <div className="max-w-5xl mx-auto px-8 py-8">
        ...
        <div className="flex items-start justify-between mb-8">
          ...
          <div className="flex gap-3 shrink-0">
            <button className="flex items-center gap-2 border border-[#1a2c5b] text-[#1a2c5b] font-semibold text-sm px-4 py-2 rounded-md hover:bg-[#1a2c5b]/5 transition-colors">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-100">
                <th className="text-left text-[10px] font-semibold text-gray-400 uppercase tracking-widest pb-2">
                  Evento
                </th>
                <th className="text-left text-[10px] font-semibold text-gray-400 uppercase tracking-widest pb-2">
                  Tipo
